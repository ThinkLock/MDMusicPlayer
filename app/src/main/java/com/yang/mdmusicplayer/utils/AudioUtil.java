...
public class AudioUtil{
    ...
    private List<Audio> mLocalMusicList;
    ...
    {
        mLocalMusicList = new ArrayList<Audio>();
        ...
        for ( cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext() )
        {
            ...
            mLocalMusicList.add(audio);
        }
        cursor.close();
    }

    public List<Audio> getmLocalMusicList() {
        return mLocalMusicList;
    }

    public void setmLocalMusicList(List<Audio> mLocalMusicList) {
        this.mLocalMusicList = mLocalMusicList;
    }
}
