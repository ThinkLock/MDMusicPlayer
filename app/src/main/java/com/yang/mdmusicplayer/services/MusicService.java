package com.yang.mdmusicplayer.services;
...
import com.yang.mdmusicplayer.receviers.AlarmReceiver;
...
//        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
        ...
        /*获取音乐相关的信息*/
        AudioUtil.getInstance(getApplicationContext()).initAudioList();
...
//        Log.d(TAG, SUB + "sendMessage" + what);
    ...
    public class MusicBinder extends Binder
    {
        ...
        public void startPlay(int currentMusic, int currentPosition)
        {
            ...
            {
                /*设置音频路径资源*/
                Audio audio = audioList.get(currentMusic);
